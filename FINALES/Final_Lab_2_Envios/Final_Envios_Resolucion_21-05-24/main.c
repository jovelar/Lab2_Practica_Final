    ...
    if(*lista)
    {
        ...
        while(iterador)
        {
            ...
            while(iterAereo)
            {
                ...
                {
                    *pila=apilar(*pila,iterAereo->tiempoViaje);
                    if(!anteAereo)
                    {
                        nodoDestino *aux=iterAereo->sig;
                        free(iterAereo);
                        iterador->destinosAereos=aux;
                        iterAereo=aux;
                    }
                    else
                    {
            ...
            if(iterador->destinosAereos==NULL && iterador->destinosFerro==NULL)
            {
                if(!ante)
                {
